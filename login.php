...
if ($errors) {
    ...
    if ($count !== 1) {
        ...
        if (empty($_POST['rememberme'])) {
            ...
            $cookieValue = f1($authentificator1, $authentificator2); // cookie store value in hexa form.
            setcookie(
                "rememberme",
                $cookieValue,
                time() + 1296000// 15*24*60*60  seconds.
            );
            ...
            $f2authentificator2 = f2($authentificator2); // hexa form m ha  Aur ek hashed form m ha binary ke
