...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="mynavbar">
                    <ul class="navbar-nav me-auto text-center" style="font-size: 24px;">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="http://codewithdeepak.in" >ContactUs</a>
                        </li>
                        <li class="nav-item"  >
                            <a class="nav-link" href="mainpageloggedin.php" class="active" >MyNotes</a>
                        </li>
                        <li class="nav-item" id="active">
                            <a class="nav-link" href="mainpageloggedin.php"  >Rate Us</a>
                        </li>
                    </ul>
    ...
    <section>
        <div class="d-flex row justify-content-center mt-5" id="row">
            <div class="col-sm-7 bg-info rounded-2 mb-3" style="box-shadow: 3px 3px white">
                <h3 class="p-2 ">Write your precious rating. And helps me in learning new things.</h3>
            </div>
            <div class="col-sm-7 p-0">
            <form method="post" id="commentform">
                    <div id="commentmessage"></div>
                    <textarea name="comment" id="comment" cols="20" rows="6" style="width: 100%" class="p-2 mb-3 rounded-2" placeholder="Write Your Precious Comment Here"></textarea>
            ...
            <div class="bg-white col-sm-7 p-2 mb-3" style="box-shadow: 3px 3px grey">All Comments</div>
            <div class="col-sm-7 p-0" id="allcomments">
...
<script scr="comment.js">
    console.log("Fun with Deepak");
    $("#commentform").submit(function(event){
        // console.log("Fuck you BAby");
        // window.alert("Fuck you BAby");
        event.preventDefault();
        var datatopost = $(this).serializeArray();
        //window.alert(datatopost);
        console.log(datatopost);
        $.ajax({
            // Here we call an comment.php file for saving comment in comment table.
            url: 'comment.php',
            type: "POST",
            data: datatopost, 
            success: function(data){
                if(data.trim() == 'success'){
                    window.alert('We Have reach your comment');
                    location.reload()
                }else{
            ...
            error: function(){
                $('#commentmessage').html("<div class='alert alert-danger' style='font-family: monospace;'><b>ERROR: </b> There is some Problem in Ajax Calls. This may be because your network is slow. </div>");
            }
        });
    });
    $(function(){
        $.ajax({
              ...
              error: function(){
                  $('#allcomments').html("<div class='alert alert-danger'>There is some error in fectching comments</div>");
              }
        });
    });
</script>
